...
The matrix representation of the problem above is \ref{tab:prisionersdillema_tab1}.
...
\multicolumn{2}{c}{} & \multicolumn{2}{c}{player 2}\tabularnewline
\cline{3-4} 
\multicolumn{2}{c|}{} & C & D\tabularnewline
\cline{2-4} 
\multirow{2}{*}{\begin{sideways}
player1
\end{sideways}} & C & (1,1) & (0,2)\tabularnewline
\cline{2-4} 
 & D & (2,0) & (0,0)\tabularnewline
\cline{2-4} 
\end{tabular}
\par\end{center}
