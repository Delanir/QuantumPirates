...
By varying the parameter $\gamma$, we can observe that the expected utility changes as we set up the initial state. Furthermore for $\gamma= \frac{\pi}{4}+k \frac{\pi}{2}, k \in {0, 1, 2, 3}$ we can se a hdnd 

\begin{table}
\begin{center}
\begin{tabular}{cc}
  \num\putindeepbox[7pt]{\includegraphics[scale=0.40]{prisionersdillema/II.PNG}}
    & \num\putindeepbox[7pt]{\includegraphics[scale=0.40]{prisionersdillema/InotI.PNG}} \\
  \num\putindeepbox[7pt]{\includegraphics[scale=0.40]{prisionersdillema/notII.PNG}}
    & \num\putindeepbox[7pt]{\includegraphics[scale=0.40]{prisionersdillema/notInotI.PNG}} \\
\end{tabular}
\caption{dde.}
