...
This means that if the second player knows the initial state and the first player plays with a classical strategy, never modifing the density matrix, the first player will be able to manipulade the game under optimal conditions.
