...
\begin{center}
\begin{tabular}{cc}
  b)\putindeepbox[7pt]{\includegraphics[scale=0.46]{3Accepted99/CCC.PNG}}
    & b1)\putindeepbox[7pt]{\includegraphics[scale=0.46]{3Accepted99/CCC_1.PNG}} \\
\end{tabular}
...
\begin{center}
\begin{tabular}{cc}
  c)\putindeepbox[7pt]{\includegraphics[scale=0.46]{3Accepted99/CCD.PNG}}
    & c1)\putindeepbox[7pt]{\includegraphics[scale=0.46]{3Accepted99/CCD_1.PNG}} \\
\end{tabular}
...
\begin{center}
\begin{tabular}{cc}
  a)\putindeepbox[7pt]{\includegraphics[scale=0.46]{3Accepted99/CDC.PNG}}
    & a1)\putindeepbox[7pt]{\includegraphics[scale=0.46]{3Accepted99/CDC_1.PNG}} \\
\end{tabular}
...
\begin{center}
\begin{tabular}{cc}
  a)\putindeepbox[7pt]{\includegraphics[scale=0.46]{3Accepted99/DCC.PNG}}
    & a1)\putindeepbox[7pt]{\includegraphics[scale=0.46]{3Accepted99/DCC_1.PNG}} \\
\end{tabular}
